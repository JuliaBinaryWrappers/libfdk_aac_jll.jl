...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libfdk_aac_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("f638f0a6-7fb0-5443-88ba-1cc74229b280"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libfdk_aac", artifacts_toml) for e in artifacts["libfdk_aac"]]
...
if best_platform === nothing
    @debug("Unable to load libfdk_aac; unsupported platform $(triplet(platform_key_abi()))")
else
